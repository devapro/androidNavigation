package pro.devapp.navigation.ui.screens.confirm
...
import pro.devapp.navigation.databinding.FragmentConfirmBinding
...
class ConfirmFragment : NavigationFragment<PublicPartNavigation>() {

    override val navigation: PublicPartNavigation by createNavigation(PublicPartNavigationController::class)
    override val viewModel by viewModels<ConfirmViewModel>()
    override val screenBinding by viewBinding(FragmentConfirmBinding::inflate)
    ...
    override fun onCreateView(
        ...
        screenBinding.goToApp.setOnClickListener { navigation.openMainAfterConfirm() }
